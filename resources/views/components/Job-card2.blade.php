<div class="flex justify-start mb-6">
    <div class="w-full">
        <div class="flex">
            ...
            <div class="flex flex-col flex-1 ml-4 bg-white border-gray-400 p-2 mt-2 rounded-sm shadow-lg ">
            ...
            <div class="flex flex-col ml-4 justify-center ">
                ...
                <div class="items-center">
                        <span class=" font-sans text-xs mb-2">
                            Publicado el {{ Carbon\Carbon::parse($job->datePosted)->format('d-m-Y') }}
                        </span>
                        <span>
                            <img class="mx-auto mb-2" src="{{ 'storage/logo_images/' . $job->logo }}">
                        </span>
